...
const FoldedBadge: React.FC<PurpleBadgeProps> = ({text,textClassName, className = ""}) => {
    return (
        <div
            ...
            <div
                className='absolute before:content-[""] bottom-0 right-0 border-8 border-solid border-b-neutral-800 border-r-neutral-800 border-t-fuchsia-800 border-l-fuchsia-800 block w-0'/>
        </div>
    );
};
