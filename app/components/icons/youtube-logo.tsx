...
export const YoutubeLogo: IconType = ({className, strokeWidth}) => {
    return (
        <svg width="800px" height="800px" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="none" className={className}>
            <path fill="red"
