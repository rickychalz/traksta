...
const navigationMenuTriggerStyle = cva(
    ...
    "hover:text-white focus:text-black dark:focus:text-white dark:data-[state=open]:text-white data-[state=open]:text-black " +
...
function NavigationMenuContent({
  ...
  return (
    <NavigationMenuPrimitive.Content
      ...
      className={cn(
        "data-[motion^=from-]:animate-in data-[motion^=to-]:animate-out data-[motion^=from-]:fade-in data-[motion^=to-]:fade-out data-[motion=from-end]:slide-in-from-right-52 data-[motion=from-start]:slide-in-from-left-52 data-[motion=to-end]:slide-out-to-right-52 data-[motion=to-start]:slide-out-to-left-52 top-1/2 left-1/2  -translate-x-1/2 w-full p-2 pr-2.5 md:absolute md:w-auto",
