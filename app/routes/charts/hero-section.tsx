...
const HeroSection = () => {
    return (
        <section>
            <div
                className={"w-full sticky top-16 md:flex items-center text-white text-sm justify-center gap-10 py-2 hidden bg-[#121212]/90 z-40"}>
                <div>
                    Top 50 Songs
                </div>
                <div>
            ...
            <div className={"relative flex flex-col items-center xl:h-115"}>
                    ...
                    <div className={"w-full bg-transparent hidden xl:grid grid-cols-5 h-full"}>
                        ...
                        <div className={"h-full grid grid-rows-3 "}>
                            <div className={"w-full h-full  row-start-1 flex flex-col justify-center text-white"}>
                                <h1 className={"font-bold text-3xl"}>Artist 100</h1>
                            ...
                            <div className={"row-start-3 flex flex-col justify-center"}>
                                <div className={"flex gap-8 items-center "}>
                                    <div className={"flex flex-col items-center gap-2"}>
                                        <div className={"text-4xl flex items-center font-bold text-white "}>
                ...
                <div className={"xl:hidden flex items-center justify-between w-full px-4 text-white py-8"}>
